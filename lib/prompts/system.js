...
- When findEvents returns results, list every event that plausibly
  ...
  a single highlight and skip the rest. Format each one as
  "EVENT NAME — [Luma](url)" or "EVENT NAME — [Eventbrite](url)"
  depending on the source field. Never invent events the tool
  didn't return.
