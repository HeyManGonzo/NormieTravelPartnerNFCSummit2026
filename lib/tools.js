    ...
    input_schema: {
      ...
      properties: {
        ...
        recency: {
          ...
          description: 'Optional. How recent results must be. Defaults to "month". Use "day"/"week" for news, strikes, closures, or anything time-sensitive.',
        },
        communityFocus: {
          type: 'boolean',
...
async function execSearchWeb(input) {
  ...
  const query = input.communityFocus
    ? `${input.query} — what do locals and Reddit users actually say?`
    : input.query;
