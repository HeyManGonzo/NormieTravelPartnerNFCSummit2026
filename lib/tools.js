...
export const TOOL_DEFINITIONS = [
  {
    ...
    description:
      'Search the curated Lisbon knowledge base. Intentionally thin: the NFC Summit venue, the 14 Lisbon neighbourhoods, day-trip destinations (Sintra, Cascais, Estoril, Carcavelos, Guincho), and any sponsored partner picks. For specific venues — restaurants, bars, galleries — this will usually return nothing; fall through to searchPlaces. Returns up to 8 matches with id, name, neighbourhood, description, tags, and price range.',
    input_schema: {
      type: 'object',
      properties: {
        query: {
        ...
        type: {
          type: 'string',
          enum: ['restaurant', 'gallery', 'bar', 'landmark', 'neighbourhood', 'day-trip', 'event'],
